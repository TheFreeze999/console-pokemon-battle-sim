namespace Types {
	...
	export type MatchupTable = Readonly<{ [DefendingType in Type]: { weaknesses: Type[], resistances: Type[], immunities: Type[] } }>;

	export function getMatchupTable(): MatchupTable {
		return {
			[Type["???"]]: {
				weaknesses: [],
				resistances: [],
	...
	export function calcEffectiveness(attackingTypes: Type[], defendingTypes: Type[], _MATCHUP_TABLE = getMatchupTable()) {
